...
var appsMod = require('marionette-apps');
var contentMod = require('marionette-content-script');
var fileManagerMod = require('marionette-file-manager');
var formsMod = require('marionette-plugin-forms');
var helperMod = require('marionette-helper');
var settingsMod = require('marionette-settings-api');

var plugins = {
  apps: appsMod,
  contentScript: contentMod,
  fileManager: fileManagerMod,
  forms: formsMod,
  helper: helperMod,
