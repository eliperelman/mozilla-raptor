...
var helpersMod = require('./lib/helpers');
var inputMod = require('./lib/input');
var loggingMod = require('./lib/logging');
var marionetteMod = require('./lib/marionette');
var modules = {
  helpers: helpersMod,
  input: inputMod,
  log: loggingMod,
  marionette: marionetteMod
};
var devices = {};
...
var Device = function(serial, options) {
  ...
  if (options.config) {
    config = merge(config, require(options.config)); // eslint-disable-line
  }
...
Device.prototype.setProperties = function() {
  ...
  return this.command()
    ...
    .then(function(output) {
      ...
      while (match = GETPROP_MATCHER.exec(value)) { // eslint-disable-line
...
Device.prototype.findConfiguration = function(deviceType, model) {
  ...
  Object
    ...
    .some(function(device) {
      var isMatch = device.toUpperCase() === model.toUpperCase();
